...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu - Moved outside nav to prevent height constraints */}
      {/* Mobile Menu Overlay */}
      <div
      ...
      />
      <div
        className={`fixed top-0 right-0 w-4/5 max-w-xs h-full bg-white backdrop-blur-md shadow-2xl z-[60] transform transition-transform duration-300 md:hidden flex flex-col pt-10 px-8 space-y-8 ${
