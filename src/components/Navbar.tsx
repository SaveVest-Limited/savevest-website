              ...
              <div className="flex items-center space-x-8">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute left-0 mt-5 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-40">
                    <div className="py-1">
                      <Link
                        href="/self-target-savings"
                        className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                      >
                        Self Target Savings
                      </Link>
                      <Link
                        href="/group-target-savings"
                        className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                      >
            ...
            <div className="hidden md:flex space-x-2 items-center">
              <Link href="/signup">
                <span
                  ...
                  } rounded-sm border border-gray-300 px-4 py-3 text-sm font-medium cursor-pointer transition duration-300`}
                >
                  Sign in
                </span>
              </Link>
              ...
              <Link href="/signup">
                <span
                  className={`${
                    isScrolled
                      ? "bg-white text-black hover:bg-gray-200"
                      : "bg-[#1D44CD] text-white"
                  } rounded-sm border border-[#1D44CD] px-4 py-3 text-sm font-medium cursor-pointer transition duration-300`}
                >
                  Create free account
                </span>
              </Link>
                ...
                <Link href="/signup" onClick={closeBar}>
                  <span
                    className={`block px-3 py-2 rounded-md text-base font-medium ${
                      isScrolled
                        ? "bg-white text-black hover:bg-gray-200"
                        : "text-white bg-[#1D44CD] hover:bg-[#1f1155]"
                    } cursor-pointer`}
                  >
                    Create free account
                  </span>
